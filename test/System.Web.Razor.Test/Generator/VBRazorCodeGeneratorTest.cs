...
{
    // Don't care about vb. Just c# and f# rules.

    [Obsolete]
    public class VBRazorCodeGeneratorTest
    { }
    ...
    /*
        public class VBRazorCodeGeneratorTest // : RazorCodeGeneratorTest<VBRazorCodeLanguage>
        {
            ...
            public void VBCodeGeneratorCorrectlyGeneratesMappingsForRazorCommentsAtDesignTime()
            {
                ...
                {
                // 01
                new GeneratedCodeMapping(4, 6, 6, 6),
                // 02
    new GeneratedCodeMapping(5, 40, 39, 2),
                // 03
                new GeneratedCodeMapping(8, 6, 6, 33),
                // 04
                new GeneratedCodeMapping(9, 46, 46, 3),
                // 05
                new GeneratedCodeMapping(12, 3, 7, 1),
        ...
        public void VBCodeGeneratorCorrectlyGeneratesFunctionsBlocksAtDesignTime()
        {
            ...
            {
                // 01
    new GeneratedCodeMapping(1, 11, 11, 4),
        ...
        public void VBCodeGeneratorGeneratesCodeWithParserErrorsInDesignTimeMode()
        {
            ...
            {
                /* 01 
                new GeneratedCodeMapping(1, 6, 6, 16)
            });
        }
        ...
        public void VBCodeGeneratorCorrectlyGeneratesInheritsAtDesigntime()
        {
            ...
            {
                /* 01 
                new GeneratedCodeMapping(1, 11, 25, 27)
            });
        }
        ...
        public void VBCodeGeneratorCorrectlyGeneratesDesignTimePragmasForUnfinishedExpressionsInCode()
        {
            ...
            {
                /* 01 
                new GeneratedCodeMapping(1, 6, 6, 2),
                /* 02 
        ...
        public void VBCodeGeneratorCorrectlyGeneratesDesignTimePragmasMarkupAndExpressions()
        {
            ...
            {
                /* 01 
                new GeneratedCodeMapping(2, 14, 13, 17),
                /* 02 
                new GeneratedCodeMapping(3, 20, 20, 1),
                /* 03 
                new GeneratedCodeMapping(3, 25, 25, 20),
                /* 04 
                new GeneratedCodeMapping(8, 3, 7, 12),
                /* 05 
                new GeneratedCodeMapping(9, 2, 7, 4),
                /* 06 
                new GeneratedCodeMapping(9, 16, 16, 3),
                /* 07 
                new GeneratedCodeMapping(9, 27, 27, 1),
                /* 08 
                new GeneratedCodeMapping(14, 6, 7, 3),
                /* 09 
                new GeneratedCodeMapping(17, 9, 24, 5),
                /* 10 
                new GeneratedCodeMapping(17, 14, 14, 28),
                /* 11 
                new GeneratedCodeMapping(19, 20, 20, 14)
            });
        }
        ...
        public void VBCodeGeneratorCorrectlyGeneratesDesignTimePragmasForCodeBlockStartedAtEOF()
        {
            ...
            {
                /* 01 
                new GeneratedCodeMapping(3, 6, 6, 0)
            });
        }
        ...
        public void VBCodeGeneratorCorrectlyGeneratesDesignTimePragmasForEmptyImplicitExpressionInCode()
        {
            ...
            {
                /* 01 
                new GeneratedCodeMapping(1, 6, 6, 6),
                /* 02 
