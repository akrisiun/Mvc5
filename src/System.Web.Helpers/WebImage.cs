    ...
    public class WebImage
    {
        ...
        public WebImage Resize(int width, int height, bool preserveAspectRatio = true, bool preventEnlarge = false)
        {
            if (width <= 0)
            {
                throw new ArgumentOutOfRangeException(
                    "width",
                    String.Format(CultureInfo.InvariantCulture, "Argument_Must_Be_GreaterThan, 0"));
            }
            if (height <= 0)
            {
                throw new ArgumentOutOfRangeException(
        ...
        public WebImage Crop(int top = 0, int left = 0, int bottom = 0, int right = 0)
        {
            if (top < 0)
            {
                throw new ArgumentOutOfRangeException(
                    "top",
                    String.Format(CultureInfo.InvariantCulture, "Argument_Must_Be_GreaterThanOrEqualTo, 0"));
            }
            if (left < 0)
            {
                throw new ArgumentOutOfRangeException(
            ...
            int padding = 5)
        {
            ...
            {
                throw new ArgumentException("Argument_Cannot_Be_Null_Or_Empty, text");
            }
            ...
            {
                throw new ArgumentOutOfRangeException("opacity", String.Format(CultureInfo.InvariantCulture, "Argument_Must_Be_Between, 0, 100"));
            }
        ...
        internal WebImage Save(HttpContextBase context, Action<string, byte[]> saveAction, string filePath, string imageFormat, bool forceWellKnownExtension)
        {
            ...
            if (String.IsNullOrEmpty(filePath))
            {
                throw new ArgumentNullException("filePath", "Argument_Cannot_Be_Null_Or_Empty");
            }
