...
namespace System.Collections.Generic
{
    ...
    /// </summary>
    // internal 
    internal static class CollectionExtensionsMvc
    {
        /// <summary>
        ...
        /// </summary>
        public static T[] AsArrayMvc<T>(this IEnumerable<T> values)
        {
        ...
        /// </summary>
        public static List<T> AsListMvc<T>(this IEnumerable<T> enumerable)
        {
            Contract.Assert(enumerable != null);
        ...
        /// </summary>
        public static void RemoveFromMvc<T>(this List<T> list, int start)
        {
        ...
        /// </summary>
        public static T SingleDefaultOrErrorMvc<T, TArg1>(this IList<T> list, Action<TArg1> errorAction, TArg1 errorArg1)
        {
            Contract.Assert(list != null);
        ...
        /// </summary>
        public static TMatch SingleOfTypeDefaultOrErrorMvc<TInput, TMatch, TArg1>(this IList<TInput> list, 
            Action<TArg1> errorAction, TArg1 errorArg1) where TMatch : class
        {
            Contract.Assert(list != null);
            Contract.Assert(errorAction != null);
        ...
        /// </summary>
        public static T[] ToArrayWithoutNullsMvc<T>(this ICollection<T> collection) where T : class
        {
